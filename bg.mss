...
#waterway::trans[zoom>=8][zoom<=11],
#waterway::trans[class='river'][zoom>=12] {
// #waterway::trans[class='canal'][zoom>=12] {
  line-color: #b1ad5d;
 // line-opacity: 0.00005;
...
#building[zoom>12] {
  ...
  [zoom=13] {  
    line-color:darken(@building,3);
    line-width:0.15;
  }
  [zoom=14] {
    line-color:darken(@building,4);
    line-width:0.15;
  }
  [zoom=15] {
